...
The walker stops after collecting 100 entries; when the cap is hit
the title shows a `(truncated to 100)` badge and the typed filter
narrows the already-collected list rather than re-walking. The same
