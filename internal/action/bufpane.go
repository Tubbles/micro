...
var BufKeyActions = map[string]BufKeyAction{
	...
	"FindNextWord":              (*BufPane).FindNextWord,
	"FindPreviousWord":          (*BufPane).FindPreviousWord,
	...
	"Redo":                      (*BufPane).Redo,
	"Copy":                      (*BufPane).Copy,
	"CopyAbsolutePath":          (*BufPane).CopyAbsolutePath,
	"CopyFileName":              (*BufPane).CopyFileName,
	"CopyLine":                  (*BufPane).CopyLine,
	"CopyRelativePath":          (*BufPane).CopyRelativePath,
	"Cut":                       (*BufPane).Cut,
	"CutLine":                   (*BufPane).CutLine,
	"Duplicate":                 (*BufPane).Duplicate,
	"DuplicateLine":             (*BufPane).DuplicateLine,
	"DuplicateLineDown":         (*BufPane).DuplicateLineDown,
	...
	"CloseAllTabs":              (*BufPane).CloseAllTabs,
	"CloseOtherTabs":            (*BufPane).CloseOtherTabs,
	"CloseTabsToTheRight":       (*BufPane).CloseTabsToTheRight,
	"CloseTabsToTheLeft":        (*BufPane).CloseTabsToTheLeft,
